...
- Wave 13 tasks 110-114: ADK eval framework (50 golden scenarios, 5 agents, EvalSuite+EvalReport+CI regression guard), Python unit tests (104 tests), Node.js unit tests (327 tests passing — all Zod schemas + pure functions), Python integration tests (42 tests — testcontainers, skip when Docker unavailable), hypothesis property-based tests (21 tests — due-date invariants, IGPM adjustment bounds, partial payment consistency, no negative charges for all valid inputs)
