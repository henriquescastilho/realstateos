...
O alvo atual de preparação do hackathon é Railway.

Arquivos principais de preparação:

- [Railway deploy guide](./README_DEPLOY_RAILWAY.md)
- [Frontend deploy notes](./apps/web/README_DEPLOY.md)
- [API deploy notes](./apps/api/README_DEPLOY.md)

Arquivos antigos de Cloud Run foram mantidos como referência técnica, mas o próximo deploy manual previsto será via Railway.
